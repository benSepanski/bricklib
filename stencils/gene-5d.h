...
constexpr unsigned GHOST_ZONE_i = 0;
constexpr unsigned GHOST_ZONE_j = 0;
constexpr unsigned GHOST_ZONE_k = 0;
constexpr unsigned GHOST_ZONE_l = 0;
...
constexpr unsigned BRICK_EXTENT_n = GZ_EXTENT_n / BDIM_n;
